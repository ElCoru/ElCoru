Raspberry SSH Setup
    ...
    1. Descargar el raspberry imager de aquí.

    2. Seleccionar el OS, en este caso Ubuntu 22.04.1, y la microSD donde se va a instalar.

    3. Abrir las opciones avanzadas y configurar el ssh.
    ...
    8. Abrir el puerto 22 y darle una dns dinámica para poder conectarse fuera de red local.
...
Pasos sacados de aquí.
    ...
    5. ‘./easyrsa gen-req myservername nopass’ Para generar la key del server y ‘./easyrsa gen-dh’ para generar los parámetros.
